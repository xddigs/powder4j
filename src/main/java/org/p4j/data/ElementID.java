...
public enum ElementID {
    ...
    MERCURY((byte) 4, "Mercury", "Hg", 0xFFCFD8DC, true, 5, false, false, false, false, true, 1),

    // 2. INORGANIC COMPOUNDS & MOLECULAR STATES
    WATER((byte) 5, "Water", "H2O", 0xFF4FA6ED, true, 2, false, false, true, false, true, 5),
    ICE((byte) 6, "Ice", "H2O(s)", 0xFFA5F2F3, true, 4, false, true, false, false, false, 0),
    STEAM((byte) 7, "Steam", "H2O(g)", 0xCCFFFFFF, true, -1, false, false, false, false, false, 0),
    ...
    ACID((byte) 10, "Acid", "HCl", 0xFF2ECC71, true, 2, false, false, false, false, true, 5),
    SALT((byte) 11, "Salt", "NaCl", 0xFFF5F5F5, true, 3, false, false, false, false, false, 0),
    ...
    LAVA((byte) 14, "Lava", "SiO2+", 0xFFFF4500, true, 3, false, false, false, true, true, 2),
    OBSIDIAN((byte) 15, "Obsidian", "SiO2+", 0xFF1C1326, false, 5, false, false, false, false, false, 0),
    CEMENT((byte) 16, "Cement", "CaCO3", 0xFF9E9E9E, true, 4, false, false, false, false, false, 0),

    // 3. ORGANICS, HYDROCARBONS & FLORA
    METHANE((byte) 17, "Methane", "CH4", 0x8800FFAA, true, -2, true, false, false, false, false, 0),
    TNT((byte) 18, "TNT", "C2H4", 0xFFC23616, false, 1, true, true, false, false, false, 0),
    GASOLINE((byte) 19, "Gasoline", "C8H18", 0xFFD4A373, true, 1, true, true, false, false, true, 5),
    OIL((byte) 20, "Oil", "CnHm", 0xFF8A9A20, true, 1, true, true, false, false, true, 4),
    WOOD((byte) 21, "Wood", "C6H10O5", 0xFF8B5A2B, true, 4, true, true, false, false, false, 0),
    PLANT((byte) 22, "Plant", "C6H10O5", 0xFF2E7D32, true, 4, true, true, false, false, false, 0),
    SEED((byte) 23, "Seed", "Sd", 0xFF8BC34A, true, 3, true, true, false, false, false, 0),

    // 4. COMPLEX MIXTURES, REAGENTS & MINERALS
    THERMITE((byte) 24, "Thermite", "Fe+Al", 0xFFB71C1C, true, 4, true, false, false, false, false, 0),
    GUNPOWDER((byte) 25, "Gunpowder", "KNO3", 0xFF53565A, true, 3, true, true, false, false, false, 0),
