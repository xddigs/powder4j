...
public class FastRender extends Canvas {
    ...
    private static int getHoveredIdx(double dy, double dx,
                                     double angleStep) {
    ...
    private static int getIdx(double dy, double dx, double angleStep) {
        return getHoveredIdx(dy, dx, angleStep);
    }
    ...
    private static int adjustBrightness(int argb, int delta) {
        int a = (argb >> 24) & K.COLOR_CHANNEL_MAX;
        int r = (argb >> 16) & K.COLOR_CHANNEL_MAX;
